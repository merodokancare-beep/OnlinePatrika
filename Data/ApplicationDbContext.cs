        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Article>().HasData(
                new Article
                {
                    ...
                    ContentNp = "काठमाडौँ — नेपालमा प्रविधि र वित्तीय कारोबारलाई थप पारदर्शी र आधुनिक बनाउन नयाँ राष्ट्रिय डिजिटल भुक्तानी प्रणाली सञ्चालनमा आएको छ। सूचना तथा सञ्चार प्रविधि मन्त्रालयले अत्याधुनिक पूर्वाधार विकासको घोषणा गरेको हो।",
                    ContentEn = "KATHMANDU — In a landmark step toward transparency and technological elevation, a new national payment infrastructure has been officially launched in Nepal.",
                ...
                new Article
                {
                    ...
                    ContentNp = "काठमाडौँ — सातै प्रदेश सरकारहरूले प्रादेशिक विकास योजनालाई थप प्रभावकारी बनाउन भौतिक पूर्वाधार र स्वास्थ्य सेवा सुदृढीकरण कार्यक्रम लागू गरेका छन्।",
                    ContentEn = "KATHMANDU — Provincial governments across Nepal have initiated coordinated development agendas to upgrade regional roads and public health facilities.",
                ...
                new Article
                {
                    ...
                    ContentEn = "KATHMANDU — The House of Representatives has passed the landmark Infrastructure and Industrial Development Bill 2026 with unanimous support.",
                ...
                new Article
                {
                    ...
                    ContentEn = "KATHMANDU — The Nepal Stock Exchange (NEPSE) index jumped 55 points today as investor sentiment turned strongly bullish.",
                ...
                new Article
                {
                    ...
                    ContentNp = "काठमाडौँ — नेपालको अद्वितीय प्राकृतिक दृश्य तथा सांस्कृति सम्पदालाई विश्वसामु चिनाउन निर्माण गरिएको विशेष भिडियो सार्वजनिक गरिएको छ।",
                    ContentEn = "KATHMANDU — A newly produced high-definition video documentary exploring Nepal's natural wonders has been released today.",
                ...
                new Article
                {
                    ...
                    ContentNp = "काठमाडौँ — देशका विभिन्न भूभागका उत्कृष्ट फोटोग्राफरहरूले खिचेका मनमोहक तस्विरहरूको फोटो ग्यालरी सङ्गालो।",
                    ContentEn = "KATHMANDU — Explore an exclusive gallery featuring breathtaking landscape photography from across Nepal.",
